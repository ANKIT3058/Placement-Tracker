...
} from "../prompts/event-extraction.prompt.js";
...
const EVENT_DOCUMENT_TYPES: ReadonlySet<DocumentType> = new Set([
...
const EMPTY_EVENT_INFORMATION: EventInformation = {};
...
export class EventExtractor {
  ...
  private async requestExtraction(text: string): Promise<RawEventExtraction> {
    ...
    return JSON.parse(cleanContent) as RawEventExtraction;
  }
  ...
  private normalizeResult(raw: RawEventExtraction): EventInformation {

import type { Participant } from "./participant-information.types.js";
...
const registrationValuesOf = (participant: Participant): string[] => {
  const values: string[] = [];
 ...
 */
export const participantMatches = (
...
export const participantsInclude = (
  ...
  return participants.some((participant) =>
    participantMatches(participant, registrationNumber),
  );
};

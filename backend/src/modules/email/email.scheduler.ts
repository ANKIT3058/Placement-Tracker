...
export const startEmailReconciliationScheduler = (): void => {
  if (timer) {
  ...
  console.log(
    `[email-reconciler] Starting, interval ${EMAIL_RECONCILE_INTERVAL_MS}ms`,
  );

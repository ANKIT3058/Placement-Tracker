import { documentClassifier as defaultClassifier, } from "./classifier/document-classifier.service.js";
import { eventExtractor as defaultEventExtractor, } from "./extractors/event-extractor.service.js";
import { participantExtractor as defaultParticipantExtractor, } from "./extractors/participant-extractor.service.js";
import { documentInsightsAssembler as defaultAssembler, } from "./document-insights-assembler.js";
...
export class DocumentIntelligenceService {
    ...
    assembler;
    constructor(classifier = defaultClassifier, eventExtractor = defaultEventExtractor, participantExtractor = defaultParticipantExtractor, assembler = defaultAssembler) {
    ...
    async analyze(parsed) {
        ...
        const eventInformation = await this.eventExtractor.extract(parsed, classification);
        const participantInformation = await this.participantExtractor.extract(parsed, classification);
        return this.assembler.assemble(classification, eventInformation, participantInformation);
    }
}
// Shared singleton for callers that don't need their own instance.
export const documentIntelligenceService = new DocumentIntelligenceService();
//# sourceMappingURL=document-intelligence.service.js.map
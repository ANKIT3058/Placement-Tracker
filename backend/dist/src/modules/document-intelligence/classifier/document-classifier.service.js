...
import { CLASSIFICATION_SYSTEM_PROMPT, buildClassificationUserPrompt, } from "./classification.prompt.js";
...
const LABEL_TO_TYPE = new Map(Object.entries(DOCUMENT_TYPE).map(([key, value]) => [key, value]));
...
export class DocumentClassifier {
    ...
    normalizeResult(raw) {
        const label = typeof raw.documentType === "string"

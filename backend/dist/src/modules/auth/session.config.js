...
// condition, expressed.
export const SESSION_COOKIE_NAME = isProduction && !cookieDomain ? "__Host-placement.sid" : "placement.sid";
...
const parseSessionSecrets = () => {
    ...
    console.warn("[session] SESSION_SECRET is unset — using an insecure development default");

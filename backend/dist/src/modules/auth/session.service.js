...
import { SESSION_ABSOLUTE_LIFETIME_MS, SESSION_COOKIE_NAME, sessionCookieOptions, } from "./session.config.js";
...
const indexSession = async (userId, sessionId) => {
...
const unindexSession = async (userId, sessionId) => {
